...
class Ur5BoxEnv(RFUniverseBaseEnv):
    ...
    def __init__(
        ...
        super().__init__(
            ...
            articulation_channel_id='d99ef273-8835-4606-a005-d208c6b7bbf0',
    ...
    def _get_obs(self):
        ...
        handle_position = np.array(self.articulation_channel.data[2]['positions'][3])
        box_open_angle = -1 * np.array([self.articulation_channel.data[2]['joint_positions'][0]])
